    ...
    def reformat_from_trade_proc_to_turn(self):
            ...
            dial_id-turn_num-dom-slot_type:
                    {
                        "dial_id": dial_id
                        "turn_num": 0,
                        "slots_inf": [slot_val1, slot_val2, ...]
                        "slots_err": "",
                        "slots_domtype" : ["dom slot_type", "dom slot_type2", ...]
        ...
        for dial in tqdm(self.dials):
            ...
            for turn in dial["dialogue"]:
                ...
                dial_key = f"{dial_id}-{turn_num}"

                turn_form["slots_inf"] = []
                turn_form["slots_dom_type"] = []
                # # # import error
                turn_form["slots_err"] = ""
                ...
                for i in range(len(slots_inf_alltype) // 4):
                    ...
                    turn_form["slots_inf"].append(slot_val)
                    turn_form["slots_dom_type"].append(f"{domain} {slot_type}")
