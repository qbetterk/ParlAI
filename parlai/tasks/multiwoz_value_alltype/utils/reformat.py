...
class Reformat_Multiwoz(object):
    ...
    def reformat_from_trade_proc_to_turn(self):
        ...
        for dial in tqdm(self.dials):
            ...
            for turn in dial["dialogue"]:
                ...
                turn_form["slots_inf"] = " ".join(slots_inf_alltype)
                turn_form["slots_dom_alltype"] = " ".join(slots_dom_alltype)
    ...
    def find_dtv_alltype(self, slots_inf):
        ...
        output: slots_dom_alltype = [dom1, typ1, val1, ",", dom1, typ2, "None", ",", ... , dom2, typ21, val21, ",", dom2, type22, "None", ",", ...]
        """
        if slots_inf == []:
            return [], []
        ...
        self.ontology_path = os.path.join(self.data_dir, "ontology.json")
