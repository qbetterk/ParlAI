...
SLOT_TYPES = ['type', 'area', 'stars', 'department', 'people', 'food', 
              'name', 'internet', 'parking', 'day', 'pricerange',
              'book stay', 'book people', 'book time', 'book day',
              'destination', 'leaveat', 'arriveby', 'departure']
SCRAMBLE_SLOT = ['destination', 'leaveat', 'arriveby', 'departure', 'food', 'name', 'time', 'pricerange', 'book time']


EASY_ERR_SLOT_TYPES = ['destination', 'leaveat', 'arriveby', 'departure']
NON_CAND_SLOT_TYPES = ['stay', 'price', 'addr',  'type', 'arrive', 'day', 'depart', 'dest',
...
CAN_BE_REPLACED = [ 'area', 'department', 'food', 
                    'name',
                    'book time', 'book day',
                    'pricerange', 'destination', 'leaveat', 'arriveby', 'departure']
            ...
            for dial_id, turn in self.old_data.items():
                ...
                for slot in cands:
                    if slot[1] in SCRAMBLE_SLOT:
                        ...
                        if old_val not in " ".join(slot_val_list_copy):# and random.choice([0,1]):
